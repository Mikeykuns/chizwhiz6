...
function OrderScreen() {
  ...
  const addPayPalScript = () => {
    ...
    script.src =
      "https://www.paypal.com/sdk/js?client-id=ASNetK8UnP4OJcqCwLPbeiHVLiD2wpLMmSE4hJAFzeECNXLFfMBUrNt5M9hdBHDhWUkV0XAUkTwloz_Z&currency=USD";
    script.async = true;
    script.onload = () => {
      setSdkReady(true);
    };
                    ...
                    <ListGroup.Item>
                      ...
                      {!sdkReady ? (
                        ...
                        <PayPalScriptProvider
                          options={{
                            "client-id":
                              "ASNetK8UnP4OJcqCwLPbeiHVLiD2wpLMmSE4hJAFzeECNXLFfMBUrNt5M9hdBHDhWUkV0XAUkTwloz_Z",
                          }}
                        >
                          <PayPalButtons
